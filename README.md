...
| Page | Description |
|------|-------------|
| 🏠 Project Overview | Goals, dataset summary, and report structure |
| 📊 Data Description | Feature groups, class distribution, statistical summary, correlation heatmap |
| 🔀 CCA Analysis | Canonical Correlation Analysis between feature sets |
| ⚙️ ML Algorithms | Theory and mechanics behind both classifiers |
| 🧹 Data Preparation | Preprocessing pipeline — scaling, splitting, outlier handling |
...
| 🏆 Conclusion | Best model verdict with full clinical justification |
...
- [UCI ML Repository](https://archive.ics.uci.edu/ml/datasets/Breast+Cancer+Wisconsin+%28Diagnostic%29) for the dataset
